...
plt.plot(h_hann, ':', color = 'r', label = 'Hann, M = 191')
plt.plot(h_hamming, ':', color = 'b', label = 'Hamming, M = 191')
plt.legend()
...
plt.subplot(311)
plt.plot(np.linspace(0,24000,len(H_hann)), H_hann, color = 'r', label = 'Hann, M = 191')
plt.plot(np.linspace(0,24000,len(H_hamming)), H_hamming, color = 'b', label = 'Hamming, M = 191')
plt.legend()
plt.xlim(0, 24000)
...
plt.grid()
plt.subplot(313)
plt.plot(np.linspace(0, 24000, len(H_hann)), 20*np.log10(H_hann), color = 'r', label = 'Hann, M = 191')
plt.plot(np.linspace(0, 24000, len(H_hamming)), 20*np.log10(H_hamming), color = 'b', label = 'Hamming, M = 191')
plt.legend()
plt.ylim(-100,10)
plt.xlabel('Frequency [Hz]')
