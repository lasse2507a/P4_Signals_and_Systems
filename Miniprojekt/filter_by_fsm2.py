...
plt.figure(figsize=(16,9))
plt.title('Frequency response', fontsize = 20)
plot_frq_response(trans_width=1, numtaps=50)
plot_frq_response(trans_width=100, numtaps=50)
plot_frq_response(trans_width=150, numtaps=50)
plot_frq_response(trans_width=200, numtaps=50)
plt.legend()


plt.figure(figsize=(16,9))
plt.title('Frequency response', fontsize = 20)
plot_frq_response_dB(trans_width=1, numtaps=50)
plot_frq_response_dB(trans_width=100, numtaps=50)
plot_frq_response_dB(trans_width=150, numtaps=50)
