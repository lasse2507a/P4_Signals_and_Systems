...
H_omega2 = H(a = 1000)
H_omega3 = H(a = 1500)
H2_k0, x21 = H_sampled2(H_omega2, 11)
H2_k1, x22 = H_sampled2(H_omega2, 13)
H2_k2, x23 = H_sampled2(H_omega2, 15)
H2_k3, x24 = H_sampled2(H_omega2, 17)
h0_2 = h(H2_k0)
h1_2 = h(H2_k1)
h2_2 = h(H2_k2)
h3_2 = h(H2_k3)
...
plt.plot(np.linspace(0, 4000, len(H2_pad0)), H2_pad0, label =  '0 Hz transition band')
plt.plot(np.linspace(0, 4000, len(H2_pad1)), H2_pad1, label =  '500 Hz transition band')
plt.plot(np.linspace(0, 4000, len(H2_pad2)), H2_pad2, label =  '1000 Hz transition band')
plt.plot(np.linspace(0, 4000, len(H2_pad3)), H2_pad3, label =  '1500 Hz transition band')
plt.xlabel('Frequency [Hz]')
plt.ylabel('Gain')
plt.ylim(0.9,1.1)
plt.xlim(0, 1000)
...
plt.plot(np.linspace(0, 4000, len(H2_pad0)), 20*np.log10(H2_pad0), label =  '0 Hz transition band')
plt.plot(np.linspace(0, 4000, len(H2_pad1)), 20*np.log10(H2_pad1), label =  '500 Hz transition band')
plt.plot(np.linspace(0, 4000, len(H2_pad2)), 20*np.log10(H2_pad2), label =  '1000 Hz transition band')
plt.plot(np.linspace(0, 4000, len(H2_pad3)), 20*np.log10(H2_pad3), label =  '1500 Hz transition band')
plt.xlabel('Frequency [Hz]')
plt.ylabel('Gain [dB]')
plt.ylim(-12, 2)
plt.xlim(500, 2000)
